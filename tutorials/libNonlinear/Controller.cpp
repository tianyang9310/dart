...
StateMachine* Controller::createWalkingStateMachine()
{
  ...
  TerminalCondition* cond1 = new BodyContactCondition(state1, mBiped->getBodyNode(std::string("h_foot_left")));
  TerminalCondition* cond2 = new TimerCondition(state2, 0.3);
  TerminalCondition* cond3 = new BodyContactCondition(state3, mBiped->getBodyNode(std::string("h_foot_right")));
 ...
 // state3->setDesiredPelvisGlobalAngleOnCoronal(DART_RADIAN * 0.0);
  ...
  //-- State 0
  //---- pelvis
  state0->setDesiredJointPosition("j_pelvis_rot_z", -pelvis); // angle b/w pelvis and torso
  //---- swing leg
  ...
  //-- State 1
  //---- pelvis
  state1->setDesiredJointPosition("j_pelvis_rot_z", -pelvis); // angle b/w pelvis and torso
  //---- swing leg
  ...
  //-- State 2
  //---- pelvis
  state2->setDesiredJointPosition("j_pelvis_rot_z", -pelvis); // angle b/w pelvis and torso
  //---- swing leg
  ...
  //-- State 3
  //---- pelvis
  state3->setDesiredJointPosition("j_pelvis_rot_z", -pelvis); // angle b/w pelvis and torso
  //---- swing leg
