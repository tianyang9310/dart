...
extern const double floor_length    = 0.4;
const double floor_width     = 0.2;   // half of floor_length
const double floor_height    = 0.01;
const double wall_length     = 0.4;   // floor_length
extern const double wall_thickness  = 0.01;  // floor_height
const double wall_height     = 0.05;  // 1/8 * floor_length

extern const double obstacle_radius = 0.05;
extern const double obstacle_height = 0.025; // half of wall_height
extern const double obstacle_2_wall = 2.5*wall_thickness;

extern const double cube_length     = 0.005;
